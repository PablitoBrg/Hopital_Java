...
public class cont_med implements ActionListener {
	...
	public cont_med() {
		...
		JLabel lblNewLabel = new JLabel("Modifier le contact d'un médecin");
		...
		JLabel lblNewLabel_1_1 = new JLabel("Nouveau contact :");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==modif) {
			...
			try {
				...
				String requete = "UPDATE `USER`.`Medecin` SET `MedContact` = '"+nvaleur+"' WHERE (`idMedecin` = '"+s+"');";
				try {
					st.execute(requete);
