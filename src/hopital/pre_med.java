...
public class pre_med implements ActionListener {
	...
	public pre_med() {
		...
		JLabel lblNewLabel = new JLabel("Modifier le prénom d'un médecin");
		...
		JLabel lblNewLabel_1_1 = new JLabel("Nouveau prénom :");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==modif) {
			...
			try {
				...
				String requete = "UPDATE `USER`.`Medecin` SET `MedPrenom` = '"+nvaleur+"' WHERE (`idMedecin` = '"+s+"');";
				try {
					st.execute(requete);
				...
				JOptionPane.showMessageDialog(frame, "Information à jour");
