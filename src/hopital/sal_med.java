...
public class sal_med implements ActionListener {
	...
	public sal_med() {
		...
		JLabel lblNewLabel = new JLabel("Modifier le salaire d'un médecin");
		...
		JLabel lblNewLabel_1_1 = new JLabel("Nouveau salaire :");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==modif) {
			...
			try {
				...
				String requete = "UPDATE `USER`.`Medecin` SET `MedSalary` = '"+nvaleur+"' WHERE (`idMedecin` = '"+s+"');";
				try {
					st.execute(requete);
