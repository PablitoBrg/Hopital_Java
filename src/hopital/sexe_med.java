...
public class sexe_med implements ActionListener {
	...
	public sexe_med() {
		...
		JLabel lblNewLabel = new JLabel("Modifier le sexe d'un médecin");
		...
		JLabel lblNewLabel_1_1 = new JLabel("Nouveau sexe :");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==modif) {
			...
			try {
				...
				String requete = "UPDATE `USER`.`Medecin` SET `MedSexe` = '"+nvaleur+"' WHERE (`idMedecin` = '"+s+"');";
				try {
					st.execute(requete);
