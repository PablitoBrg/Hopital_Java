...
public class spe_med implements ActionListener {
	...
	public spe_med() {
		...
		JLabel lblNewLabel = new JLabel("Modifier la spécialité d'un médecin");
		...
		JLabel lblNewLabel_1_1 = new JLabel("Nouvelle spécialité :");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==modif) {
			...
			try {
				...
				String requete = "UPDATE `USER`.`Medecin` SET `MedSpe` = '"+nvaleur+"' WHERE (`idMedecin` = '"+s+"');";
				try {
					st.execute(requete);
